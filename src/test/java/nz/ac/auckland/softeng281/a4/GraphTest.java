...
public class GraphTest {
	...
	public static class GraphSystemTest {
		...
		@Test
		public void testShortestPathLessWeightEvenIfMoreNodes() {
			runTest("g7.txt", "path 1 2");
			assertTrue(myOut.toString().contains("The shortest path is: 1 -> 7 -> 2 cost: 4"));
			assertFalse(myOut.toString().contains("The shortest path is: 1 -> 2 cost: 10"));
		}
